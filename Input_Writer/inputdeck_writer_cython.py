...
# from   cyBinout_reading  import binout_reading
# from   cysmall_func      import *
    ...
    def write_reduced_inputdeck(self, red_elem_set, contact_elem_set=[], lastECSWElement=1e11, newfilename=None, \
        ...
        if not keep_all_nodes:
            ...
            for i in self.nodeticketpos:
                ...
                n_ticket_id += 1
            output_tickets = self.remove_nodes_from_sets(output_tickets, omitted_nodes_ext)
...
if __name__ == "__main__":
    ...
    # elif run == 'XDMF Time series':
    #     spath = '/proj/insass3283c/Bach/01_Promotion/20_MOR_LSDYNA/ECSW/ls_dyna/11_Crush_tube/'
    #     deck         = inputdeck(os.path.join(spath, 'tube_plate_nofail_ev.key'))
    #     model_binout = Binout(os.path.join(spath, 'NOFAILTube_Plate_40BV_tau002_ShiftConst05_08_regrot0005_N4_TSS_0.9_0.9/tube_plate_nofail_ev_ecsw_nocontactele.key.binout'))
    #     ref_binout   = Binout(os.path.join(spath, 'NOFAILTube_Plate_40BV_tau002_ShiftConst05_08_regrot0005_N4_TSS_0.9_0.9/tube_plate_nofail_ev_reference_dtscalFOM.key.binout'))
    #     deck.create_timeseries_xdmf(model_binout, reference_binout=ref_binout, ECSW_weights=None, xdmffile='/proj/insass3283c/Bach/01_Promotion/20_MOR_LSDYNA/ECSW/test.xdmf3',   \
    #                                 pids=None, reduceNodes=False, lastECSWElement=999999999, numnodes=None, interp_time = True, hasRot=True, memory_mapped=False)